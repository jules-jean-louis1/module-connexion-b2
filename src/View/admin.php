                ...
                <thead class="py-1 bg-[#f1f2f3] border border-[#52586633] text-center rounded-t-2xl">
                    ...
                    <th class="p-1.5 border-r border-[#52586633] hover:bg-[#EAEBEC]">
                        <button type="button" value="default" name="firstname" id="btnFirstname" class="flex space-x-2 items-center">
                            <span>Prénom</span>
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" id="svg_firstname" class="icon icon-tabler icon-tabler-arrows-down-up" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="#676a6d" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    <path d="M17 3l0 18"/>
                                    <path d="M10 18l-3 3l-3 -3"/>
                                    <path d="M7 21l0 -18"/>
                    ...
                    <th class="p-1.5 border-r border-[#52586633] hover:bg-[#EAEBEC]">
                        <button type="button" value="default" name="lastname" id="btnLastname" class="flex space-x-2 items-center">
                            <span>Nom</span>
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" id="svg_lastname" class="icon icon-tabler icon-tabler-arrows-down-up" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="#676a6d" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    <path d="M17 3l0 18"/>
                                    <path d="M10 18l-3 3l-3 -3"/>
                                    <path d="M7 21l0 -18"/>
                    ...
                    <th class="p-1.5 border-r border-[#52586633] hover:bg-[#EAEBEC]">
                        <button type="button" value="default" name="role" id="btnRole" class="flex space-x-2 items-center">
                            <span>Rôle</span>
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" id="svg_role" class="icon icon-tabler icon-tabler-arrows-down-up" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="#676a6d" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    <path d="M17 3l0 18"/>
                                    <path d="M10 18l-3 3l-3 -3"/>
                                    <path d="M7 21l0 -18"/>
                    ...
                    <th class="p-1.5 border-r border-[#52586633] hover:bg-[#EAEBEC]">
                        <button type="button" value="default" name="created_at" id="btnCreatedAt" class="flex space-x-2 items-center">
                            <span>Créer le</span>
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" id="svg_created_at" class="icon icon-tabler icon-tabler-arrows-down-up" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="#676a6d" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    <path d="M17 3l0 18"/>
                                    <path d="M10 18l-3 3l-3 -3"/>
                                    <path d="M7 21l0 -18"/>
                    ...
                    <th class="p-1.5 hover:bg-[#EAEBEC]">
                        <button type="button" value="default" name="updated_at" id="btnUpdatedAt" class="flex space-x-2 items-center">
                            ...
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" id="svg_updated_at" class="icon icon-tabler icon-tabler-arrows-down-up" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="#676a6d" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    <path d="M17 3l0 18"/>
                                    <path d="M10 18l-3 3l-3 -3"/>
                                    <path d="M7 21l0 -18"/>
